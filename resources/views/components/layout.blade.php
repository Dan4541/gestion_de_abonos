...
<html lang="en">
    <head>
        ...
        <title>Tienda Boutique Teresita</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Boutique Teresita</a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="{{ route('abonos-index') }}">
                                Abonos
                            </a>
                    ...
                    <div class="sb-sidenav-footer">
                        ...
                        <strong>Danny Castillo Solano  B71803</strong>
                    </div>
                </nav>
            </div>
